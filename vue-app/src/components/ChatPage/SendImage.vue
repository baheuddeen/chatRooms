...
<template>
  <div>
    <div :class="{'image-previwe': true, 'd-none': !isPreviewing}">
        <div class="close" @click="() => isPreviewing = false"><span class="pi pi-times"></span></div>
        <img ref="imagePreview" alt="image" />
        <Button @click="onUploadImage" class="white-bg btn"> Send </Button>
    </div>
